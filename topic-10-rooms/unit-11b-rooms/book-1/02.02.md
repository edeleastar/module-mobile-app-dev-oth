...
Keeping the EditLocationPresenter as it currently is, replace the EditLocationView with this version:

## views/editlocation/EditLocationView
...
Test this now - the location lat/lng, visible along the top of the activity, should vary as you drag the marker.